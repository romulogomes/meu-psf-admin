<?php
	...
	$sql = "SELECT a.nome as nome_aluno, disciplina_fk, nota, bimestre, d.nome 
         	FROM `notas`,`alunos` as a, `disciplinas` as d 
         	WHERE d.id_disciplina = disciplina_fk and a.id_aluno = aluno_fk and bimestre = $bimestre and aluno_fk = $id_aluno";
